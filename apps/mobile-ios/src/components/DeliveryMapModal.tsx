...
<body>
  ...
  <script>
    ...
    // - Nếu không có tên quán: structured search tách số nhà + tên đường → fallback NDAMaps
    function geocodeAddr(addr, callback, nameHint) {
      ...
      if (nameHint && nameHint.trim()) {
        ...
        // Không có tên quán → structured search
  ...
  return (
    <Modal visible={visible} animationType="slide" statusBarTranslucent onRequestClose={onClose}>
      <View style={S.root}>
        ...
        <WebView
          ref={webviewRef}
          source={{ html: buildHTML(mode, destAddress, destName, secondAddress, secondName, shipperAddress, shipperName, destCoord, secondCoord), baseUrl: 'https://mapapis.ndamaps.vn' }}
          style={{ flex: 1 }}
          javaScriptEnabled
          domStorageEnabled
