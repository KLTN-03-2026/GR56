      ...
      map.on('load', function() {
        if (USER_LOC) {
          ...
          new maplibregl.Marker({ element: el })
            ...
            .setPopup(new maplibregl.Popup({ offset: 10 }).setHTML('<b>Ban dang o day</b>'))
            .addTo(map);
        }
        ...
        RESTAURANTS.forEach(function(r) {
          ...
          var popupHtml = '<div class="popup-content">' + imgHtml + '<h3>' + (r.ten_quan_an || 'Quan an') + '</h3><p>' + (r.dia_chi || '') + '</p><button class="btn-detail" onclick="window.ReactNativeWebView.postMessage(JSON.stringify({action: \\'DETAIL\\', id: ' + r.id + '}))">Xem chi tiet</button></div>';
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Ban Do Quan An</Text>
      </View>
      ...
      <View style={styles.mapContainer}>
        {loading ? (
          ...
          <View style={styles.errorView}>
            ...
            <Text style={styles.errorText}>Khong the tai ban do</Text>
            <Text style={styles.errorSubText}>Vui long kiem tra ket noi internet</Text>
          </View>
        ) : (
          <WebView
